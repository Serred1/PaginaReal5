...
$query = "SELECT u.nombre, u.apellido, c.fecha_conexion
          FROM usuarios u
...
if ($resultado->num_rows > 0) {
    ...
    echo "<table>";
    echo "<tr><th>Nombre</th><th>Apellido</th><th>Fecha y Hora de Conexión</th></tr>";

    // Itera a través de las filas del resultado y muestra los datos en la tabla
    while ($fila = $resultado->fetch_assoc()) {
        echo "<tr><td>" . $fila["nombre"] . "</td><td>" . $fila["apellido"] . "</td><td>" . $fila["fecha_conexion"] . "</td></tr>";
    }
    echo "</table>";
} else {
